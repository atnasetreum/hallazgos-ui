...
export default function TableHallazgos({ rows }: Props) {
      ...
      <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
        <TableHead>
          <TableRow>
            ...
            <TableCell>Tipo de evidencia</TableCell>
        ...
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={row.id}>
              ...
              <TableCell>{row.manufacturingPlant.name}</TableCell>
              <TableCell>{row.mainType.name}</TableCell>
              <TableCell>{row.secondaryType.name}</TableCell>
